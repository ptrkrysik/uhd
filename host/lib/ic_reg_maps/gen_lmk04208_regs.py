...
########################################################################
address0               0[0:4]     0
CLKout0_DIV            0[5:15]    25
CLKout0_HS             0[16]      0
RESET                  0[17]      0          no_reset, reset
CLKout0_DDLY           0[18:27]   0
CLKout0_ADLY_SEL       0[28:29]   0          d_pd, d_ev_x, d_odd_y, d_both
Required_0             0[30]      0
CLKout0_PD             0[31]      1          power_up, power_down
########################################################################
## address 1
########################################################################
address1               1[0:4]     1
CLKout1_DIV            1[5:15]    25
CLKout1_HS             1[16]      0
Powerdown              1[17]      0          normal, disabled
CLKout1_DDLY           1[18:27]   0
CLKout1_ADLY_SEL       1[28:29]   0          d_pd, d_ev_x, d_odd_y, d_both
Required_1             1[30]      0
CLKout1_PD             1[31]      1          power_up, power_down
########################################################################
## address 2
########################################################################
address2               2[0:4]     2
CLKout2_DIV            2[5:15]    25
CLKout2_HS             2[16]      0
Required_2_17          2[17]      0
CLKout2_DDLY           2[18:27]   0
CLKout2_ADLY_SEL       2[28:29]   0          d_pd, d_ev_x, d_odd_y, d_both
Required_2_30          2[30]      0
CLKout2_PD             2[31]      1          power_up, power_down
########################################################################
## address 3
########################################################################
address3               3[0:4]     3
CLKout3_DIV            3[5:15]    1
CLKout3_HS             3[16]      0
Required_3_17          3[17]      0
CLKout3_DDLY           3[18:27]   0
CLKout3_ADLY_SEL       3[28:29]   0          d_pd, d_ev_x, d_odd_y, d_both
CLKout3_OSCin_Sel      3[30]      1          VCO,OSCin
CLKout3_PD             3[31]      0          power_up, power_down
########################################################################
## address 4
########################################################################
address4               4[0:4]     4
CLKout4_DIV            4[5:15]    25
CLKout4_HS             4[16]      0
Required_4_17          4[17]      0
CLKout4_DDLY           4[18:27]   0
CLKout4_ADLY_SEL       4[28:29]   0          d_pd, d_ev_x, d_odd_y, d_both
CLKout4_OSCin_Sel      4[30]      0          VCO, OSCin
CLKout4_PD             4[31]      0          power_up, power_down
########################################################################
## address 5
########################################################################
address5               5[0:4]     5
CLKout5_DIV            5[5:15]    25
CLKout5_HS             5[16]      0
Required_5_17          5[17]      0
CLKout5_DDLY           5[18:27]   0
CLKout5_ADLY_SEL       5[28:29]   0          d_pd, d_ev_x, d_odd_y, d_both
Required_5_30          5[30]      0
CLKout5_PD             5[31]      1          normal, power_down
########################################################################
## address 6
########################################################################
...
address6               6[0:4]     6
CLKout0_ADLY           6[5:9]     0
Required_6_10          6[10]      0
CLKout1_ADLY           6[11:15]   0
Required_6_16_19       6[16:19]   0
CLKout0_TYPE           6[20:23]   0          ${CLKoutX_TYPE_ENUMS}
CLKout1_TYPE           6[24:27]   0          ${CLKoutX_TYPE_ENUMS}
Required_6_28_31       6[28:31]   0
########################################################################
## address 7
########################################################################
address7               7[0:4]     7
CLKout2_ADLY           7[5:9]     0
Required_7_10          7[10]      0
CLKout3_ADLY           7[11:15]   0
Required_7_16_19       7[16:19]   0
CLKout2_TYPE           7[20:23]   0           ${CLKoutX_TYPE_ENUMS}
CLKout3_TYPE           7[24:27]   0           ${CLKoutX_TYPE_ENUMS}
Required_7_28_31       7[28:31]   0
########################################################################
## address 8
########################################################################
address8               8[0:4]     8
CLKout4_ADLY           8[5:9]     0
Required_8_10          8[10]      0
CLKout5_ADLY           8[11:15]   0
CLKout4_TYPE           8[16:19]   0           ${CLKoutX_TYPE_ENUMS}
Required_8_20_23       8[20:23]   0
CLKout10_TYPE          8[24:27]   0           ${CLKoutX_TYPE_ENUMS}
Required_8_28_31       8[28:31]   0
########################################################################
## address 9
########################################################################
address9               9[0:4]     9
...
SYNC_MUX               11[18:19]  0           log_low=0,CLKin2_LOS=1,CLKin2_Selected=2,uWire_RB=3
NO_SYNC_CLKout0        11[20]     0           clock_xy_sync=0,clock_xy_nosync=1
NO_SYNC_CLKout1        11[21]     0           clock_xy_sync=0,clock_xy_nosync=1
NO_SYNC_CLKout2        11[22]     1           clock_xy_sync=0,clock_xy_nosync=1
NO_SYNC_CLKout3        11[23]     1           clock_xy_sync=0,clock_xy_nosync=1
NO_SYNC_CLKout4        11[24]     0           clock_xy_sync=0,clock_xy_nosync=1
NO_SYNC_CLKout5        11[25]     0           clock_xy_sync=0,clock_xy_nosync=1
...
Required_13_7          13[7]      1           no_valid_use=0,valid_use=1
