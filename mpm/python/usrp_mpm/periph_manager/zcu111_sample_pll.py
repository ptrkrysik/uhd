...
class LMX2594X4xx(LMX2594):
    ...
    def config(self, output_freq):#, brc_freq, is_legacy_mode=False):
        ...
        # Configuration for 
        # input clock: 122.88e6
        # sample clock: 2.94912e9
        registers=[ 0x700000, 0x6F0000, 0x6E0000, 0x6D0000, 0x6C0000, 0x6B0000,
                    ...
                    0x4C000C, 0x4B0840, 0x4A0000, 0x49003F, 0x480001, 0x470081,
                    ...
                    0x280000, 0x270001, 0x260000, 0x250404, 0x240060, 0x230004,
                    ...
                    0x040a43, 0x030642, 0x020500, 0x010808, 0x002498]

        addr_vals = [ ((reg >> 16) & 0x7f, reg & 0xffff) for reg in registers]
